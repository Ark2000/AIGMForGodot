# Content from https://platform.moonshot.cn/docs/guide/use-kimi-api-to-complete-tool-calls

使用 Kimi API 完成工具调用（tool_calls） - Kimi API 开放平台
...
[流式输出指南](https://platform.moonshot.cn/docs/guide/utilize-the-streaming-output-feature-of-kimi-api) [使用联网搜索工具](https://platform.moonshot.cn/docs/guide/use-web-search)
