# Content from https://platform.moonshot.cn/docs/guide/auto-reconnect

自动断线重连 - Kimi API 开放平台
...
[使用视觉模型](https://platform.moonshot.cn/docs/guide/use-kimi-vision-model) [流式输出指南](https://platform.moonshot.cn/docs/guide/utilize-the-streaming-output-feature-of-kimi-api)
