# Content from https://platform.moonshot.cn/docs/api/files
...
[Partial Mode](https://platform.moonshot.cn/docs/api/partial) [计算 Token](https://platform.moonshot.cn/docs/api/estimate)
