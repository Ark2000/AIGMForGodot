# Content from https://platform.moonshot.cn/docs/api/estimate

计算 Token - Kimi API 开放平台
...
[文件接口](https://platform.moonshot.cn/docs/api/files) [查询余额](https://platform.moonshot.cn/docs/api/balance)
