# Content from https://platform.moonshot.cn/docs/api/partial

Partial Mode - Kimi API 开放平台
...
[Tool Use](https://platform.moonshot.cn/docs/api/tool-use) [文件接口](https://platform.moonshot.cn/docs/api/files)
